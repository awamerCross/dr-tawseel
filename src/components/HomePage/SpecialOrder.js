...
import {Button, Textarea, Toast, Root} from 'native-base'
        ...
        <View style={{ flex: 1 }}>
            ...
            <ScrollView style={{ flex: 1 }}>
                ...
                <View style={{marginTop:15}}>
                    ...
                    <Textarea
                        style={{ backgroundColor: '#eaeaea', borderColor: '#eaeaea', textAlignVertical: 'top', paddingTop: 10 , height:150, marginTop: 40 ,
                            width:'90%' , alignSelf:'center' ,fontFamily: 'flatMedium' , fontSize: 13, textAlign : I18nManager.isRTL ? 'right' : 'left' , borderRadius:5}}
                        onChangeText={(e) => setDesc(e)}
                        value={desc}
                        placeholder={i18n.t('writeOrderDet')}
                ...
                <Root>
                    <View style={styles.centeredView}>
                        <View style={styles.modalView}>
                            ...
                            <BTN title={i18n.t('save')} onPress={() => onSetPlace() } ContainerStyle={[styles.Btn, { marginTop: 15 }]} TextStyle={{ fontSize:13 }} />
                            <BTN title={i18n.t('cancel')} onPress={() => { setSaveLocmMdalVisible(false)}} ContainerStyle={{ marginTop: 10, borderRadius: 20, backgroundColor: '#B4B4B4' }} TextStyle={{ fontSize:13 , color:'#000'}} />
                        </View>
                    </View>
                </Root>
            </Modal>
            ...
            <Modal
                ...
                <View style={styles.centeredView}>
                    <View style={styles.modalView}>
                        ...
                        <BTN title={i18n.t('done')} onPress={() => { setModalVisible(false); }} ContainerStyle={{ marginVertical: 10, borderRadius: 20, }} TextStyle={{ height: 30 }} />
                    </View>
                </View>
            </Modal>
        </View>
