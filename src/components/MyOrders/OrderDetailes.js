                        ...
                        <ScrollView style={{ flex: 1 }} showsVerticalScrollIndicator={false}>
                            ...
                            <View style={styles.card}>
                                {
                                    orderDetails && orderDetails.provider ?
                                        <View style={{ flexDirection: 'row', flex: .75 }}>
                                            <View style={{ backgroundColor: '#f8f8f8', width: 70, height: 70, borderRadius: 5, justifyContent: 'center', alignItems: 'center' }}>
                                                <Image source={{ uri: orderDetails.provider.avatar }} style={styles.ImgCard} resizeMode={'cover'} />
                                            </View>
...

                            {
                                orderDetails.type !== 'special' &&
                                    ...
                                    <View>
                                        <Text style={{ marginHorizontal: 30, fontFamily: 'flatMedium', }}>{i18n.t('WaitOrders')}</Text>
                                        <CountDown
                                            id={counterID}
                            ...
                            }
                            {
                                ...
                                orderDetails.type !== 'special' ?
                                    <View>
                                        ...
                                        <View style={{ paddingHorizontal: width * .03, paddingTop: 20, backgroundColor: '#fff' }}>
                                            <View style={styles.followStep}>
                                                ...
                                                <Text style={[styles.nText, { marginHorizontal: 0 }]}>{i18n.t('progressOrder')}</Text>
                                            ...
                                            <View style={[styles.followStep]}>
                                                ...
                                                <Text style={[styles.nText, { marginHorizontal: 0 }]}>{i18n.t('readyOrder')}</Text>
                                                <View style={[styles.stepLine,
                                            ...
                                            <View style={[styles.followStep]}>
                                                ...
                                                <Text style={[styles.nText, { marginHorizontal: 0 }]}>{i18n.t('delegateAccept')}</Text>
                                                <View style={[styles.stepLine,
                                            ...
                                            <View style={[styles.followStep]}>
                                                ...
                                                <Text style={[styles.nText, { marginHorizontal: 0 }]}>{i18n.t('delegateArrived')}</Text>
                                            </View>
                                        </View>
                                    </View>
                            ...
                            <View style={{ flexDirection: 'column', borderWidth: 1, borderColor: '#ddd', marginTop: 5 }}>
                                <View style={styles.accordion}>
                                    <Text style={[styles.DText, { color: Colors.sky, fontSize: 16 }]}>{i18n.t('deliverLocation')}</Text>
                                </View>
                            ...
                            <View style={{ flexDirection: 'column', borderWidth: 1, borderColor: '#ddd', marginTop: 5 }}>
                                <View style={styles.accordion}>
                                    <Text style={[styles.DText, { color: Colors.sky, fontSize: 16 }]}>{i18n.t('payMethod')}</Text>
                                </View>

                                <View style={[{ width: '100%', flexDirection: 'row', alignItems: 'center', paddingHorizontal: 15, backgroundColor: '#fff', borderWidth: 1, borderColor: '#ddd', height: 50, }]}>
                                    <Icon type={'FontAwesome'} name={'money'} style={{ color: Colors.sky, fontSize: 15 }} />
                                    <Text style={[styles.nText, { fontSize: 13 }]}>{orderDetails.payment_text}</Text>
                                </View>
                            </View>

                            <TouchableOpacity onPress={() => { setToggle(!toggle), setIsOpen(false) }}>
                                <View style={styles.accordion}>
                                    <Text style={[styles.DText, { color: Colors.sky, fontSize: 16 }]}>{i18n.t('orderDetails')}</Text>
                                    <Image source={toggle ? require('../../../assets/images/arro.png') : require('../../../assets/images/arrblue.png')} style={{ width: 10, height: 10, alignSelf: 'center', marginHorizontal: 20 }} resizeMode={'contain'} />
                                </View>
                            </TouchableOpacity>
                            ...
                            <View >
                                        ...
                                        <>
                                            {
                                                orderDetails.type != 'special' ?
                                                    orderDetails.products && orderDetails.products.map((product, i) => (
                                                        <View key={i} style={{ width: '100%', backgroundColor: '#f8f8f8', marginBottom: 5, flex: 1 }}>
                                                            <View style={{ flexDirection: 'row', width: '100%', backgroundColor: '#fff', borderWidth: 1, borderColor: '#ddd', height: 50, justifyContent: 'center', alignItems: 'center', alignSelf: 'flex-start' }}>

                                                                <Text style={[styles.nText, { color: Colors.sky, fontSize: 11, }]}>{product.name.length > 15 ? (product.name).substr(0, 15) + '...' : product.name}</Text>
                                                                <TouchableOpacity onPress={() => { setClick(true); setModelProduct(product) }}>

                                                                    <Text style={[styles.oText, { color: Colors.fontBold, fontSize: 12, marginHorizontal: 8, fontFamily: 'flatMedium', }]}>({i18n.t('details')})</Text>
                                                                </TouchableOpacity>
                                                                <Text style={[styles.nText, { fontSize: 10, color: Colors.sky }]}>( {product.price} {i18n.t('RS')})</Text>

                                                                {/* <View style={{ borderRightWidth: 1, borderRightColor: Colors.sky, paddingHorizontal: 10, }}>
                                                                </View> */}
                                                                <Text style={{ color: Colors.fontNormal, fontFamily: 'flatMedium', }}>{i18n.t('total')}  :</Text>
                                                                <Text style={[styles.nText, { color: Colors.sky }]}> {orderDetails.total} {i18n.t('RS')}</Text>
                                ...
                                >
                                    ...
                                    <View style={styles.modalView}>
                                        ...
                                        <View style={{ flexDirection: 'column', marginTop: 10, marginLeft: 10, }}>
                                            ...
                                            <View style={{ flexDirection: 'row' }} >
                                                <Text style={[styles.nText, { color: Colors.fontNormal }]}> {i18n.t('quantity')} : </Text>
                                                <Text style={[styles.nText]}> ({ModelProduct.quantity})</Text>
                                            </View>

                                            <View style={{ flexDirection: 'row' }} >
                                                <Text style={[styles.nText, { color: Colors.fontNormal }]}> {i18n.t('taxes')} : </Text>
                                                <Text style={[styles.nText]}> ({orderDetails.added_value} {i18n.t('RS')})</Text>
                                            </View>

                                            <View style={{ flexDirection: 'row' }} >
                                                <Text style={[styles.nText, { color: Colors.fontNormal }]}> {i18n.t('delevierPrice')} : </Text>
                                                <Text style={[styles.nText]}> ({orderDetails.shipping} {i18n.t('RS')})</Text>
                                            </View>
                                    ...
                                    user && user.user_type === 2 && orderDetails.delegate && orderDetails.status !== 'DELIVERED' ?
                                        <View style={{ flexDirection: 'column' }}>
                                            ...
                                            <View style={[styles.warb, { width: '90%', alignSelf: 'center', borderRadius: 3, paddingHorizontal: 20 }]}>
                                                <Text style={[styles.nText, { alignSelf: 'flex-start' }]}>{orderDetails.delegate.name}</Text>
                                            </View>

                                            <Text style={[styles.nText, { marginHorizontal: width * .08, marginVertical: 10 }]}>{i18n.t('phone')}</Text>
                                            <View style={{ flexDirection: 'row', alignSelf: 'center' }}>
                                                <View style={[styles.warb, { width: '70%', borderRadius: 3, paddingHorizontal: 20 }]}>
                                                    <Text style={[styles.nText, { textAlign: 'left' }]}>{orderDetails.delegate.phone}</Text>
                                                </View>
                                                <TouchableOpacity onPress={() => Linking.openURL(`tel://${orderDetails.delegate.phone}`)} style={{ backgroundColor: Colors.sky, justifyContent: 'center', alignItems: 'center', borderRadius: 5 }}>
                                                    <Text style={[styles.aloneText, { color: '#fff' }]}>{i18n.t('call')}</Text>
                                                </TouchableOpacity>
                                            </View>

                                            <TouchableOpacity style={{ marginTop: 20 }} onPress={() => navigation.navigate('Followrepresentative', { address: orderDetails.address, orderDetails })}>
...

                                {
                                    Isopen ?
                                        <View style={{ flexDirection: 'column' }}>
                                            <Text style={[styles.nText, { marginHorizontal: width * .08, marginVertical: 10 }]}>{i18n.t('clientName')}</Text>
                                            <View style={[styles.warb, { width: '90%', alignSelf: 'center', borderRadius: 3, paddingHorizontal: 20 }]}>
                                                <Text style={[styles.nText, { justifyContent: 'center' }]}>اوامر الشبكه</Text>
                                            </View>
